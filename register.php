...
<body>
    ...
    <div class="form-reg">
        <form action="registerProcess.php" method="post" enctype="multipart/form-data" >
            ...
            <div>
                Tgl Lahir
                <input type="text" name="tgl-lahir">
            </div>
            <div>
                NIK
            ...
            <div class="file-input">
                Foto Profil
                <input type="file" name="berkas" id="choose" style="display:none;">
            ...
            <div>
                <!-- <button type="button" name="submit" class="submit-button">Register</button> -->
